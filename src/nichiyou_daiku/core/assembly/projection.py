...
from ..connection import BoundAnchor
...
def project_joint(
    ...
    Examples:
        ...
        >>> # Create two pieces and bound anchors
        ...
        >>> src_bound = BoundAnchor(piece=src_piece, anchor=src_anchor)
        >>> dst_bound = BoundAnchor(piece=dst_piece, anchor=dst_anchor)
...
def _project_surface_point(
    ...
    Internal function that transforms a SurfacePoint from one piece's coordinate
