...
class TestOptimizeCuts:
    ...
    def test_should_use_multiple_boards_when_needed(self):
        ...
        pieces = [
            PieceResource(
                id="p1", type=PieceType.PT_2x4, length=2000.0,
                width=89.0, height=38.0, volume=0
            ),
            PieceResource(
                id="p2", type=PieceType.PT_2x4, length=2000.0,
                width=89.0, height=38.0, volume=0
            )
        ]
    ...
    def test_should_choose_optimal_board_length(self):
        ...
        pieces = [
            PieceResource(
                id="p1", type=PieceType.PT_2x4, length=1500.0,
                width=89.0, height=38.0, volume=0
            )
        ]
...
class TestGenerateBillOfMaterials:
    ...
    def test_should_generate_bom_table(self):
        ...
        pieces = [
            PieceResource(
                id="leg1", type=PieceType.PT_2x4, length=750.0,
                width=89.0, height=38.0, volume=2_536_500.0
            ),
            PieceResource(
                id="top1", type=PieceType.PT_1x4, length=1200.0,
                width=89.0, height=19.0, volume=2_029_200.0
            )
        ]
...
class TestGenerateCutList:
    ...
    def test_should_generate_cut_list(self):
        ...
        pieces = [
            ...
            PieceResource(
                id="leg2", type=PieceType.PT_2x4, length=750.0,
                width=89.0, height=38.0, volume=0
            )
        ]
...
class TestGenerateMarkdownReport:
    ...
    def test_should_generate_complete_report(self):
        ...
        pieces = [
            PieceResource(
                id="test", type=PieceType.PT_2x4, length=1000.0,
